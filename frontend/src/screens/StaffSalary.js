...
const StaffSalary = ({ history }) => {
  ...
  const staffOptions = staffs.map(staff => ({ value: staff.staffId, label: staff.staff_name }));
  ...
  const handleSelectChange = (selectedOption) => {
    ...
    const selectedStaffData = staffs.find(staff => staff.staffId === selectedOption.value);
